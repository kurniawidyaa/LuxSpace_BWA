            ...
            <div class="w-auto">
              ...
              >
                <li class="mx-3 py-6 md:py-0">
                  <a href="#" class="text-black {{ Route::current()->getName() == 'md:text-white' ? 'md:text-black' : '' }}hover:underline"
                    >Showcase</a
                  >
                </li>
                <li class="mx-3 py-6 md:py-0">
                ...
                @auth
                <li class="mx-3 py-6 md:py-0">
                  <a href="{{ route('dashboard.index') }}" class="text-black {{ Route::current()->getName() == 'md:text-white' ? 'md:text-black' : '' }}hover:underline"
                    >Dashboard</a
                  >
                </li> 
                @endauth
